...
if not GROQ_API_KEY or not API_KEY:
    raise ValueError("Missing API keys. Set GROQ_API_KEY and API_KEY in environment variables.")
...
def calculate_scores1(total_lectures_taken, avg_attendance, avg_marks, curriculum_lectures):
    """
...
def process_scores():
    ...
    # Calculate scores
    faculty_score, attendance_score, marks_score, student_score = calculate_scores1(total_lectures_taken, avg_attendance, avg_marks, total_lectures_assigned)
